...
export class ReservasService {
  ...
  actualizarReservasPendientes(form: any, restaurant: string) {
    var tokenlocalstorage = localStorage.getItem('token');
    return this.http.post(this.localhost + 'api/reservas/actualizarDoc' + '?Restaurant=' + restaurant, form,
      {
        headers: { 'token': tokenlocalstorage }
      });
  }
  ...
  getReservasRangoMain(desde: any, hasta: any, restaurante: any) {
    var tokenlocalstorage = localStorage.getItem('token');
  ...
  vincularReservas(form: any) {
    var tokenlocalstorage = localStorage.getItem('token');
    return this.http.post(this.localhost + 'api/reservas/vincularDocumentos', form, {
      headers: { 'token': tokenlocalstorage }
    });
  }
}
